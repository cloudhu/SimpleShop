...
DEFINE_LOG_CATEGORY(LogSimpleShop);

//////////物品类型目录的标签声明///////////////
UE_DEFINE_GAMEPLAY_TAG(TAG_Item_Type_All, "Item.Type.All");//所有类型
...
UE_DEFINE_GAMEPLAY_TAG(TAG_Item_Type_AuxiliaryProps, "Item.Type.AuxiliaryProps");//辅助品
...
UE_DEFINE_GAMEPLAY_TAG(TAG_Item_Type_Shoes, "Item.Type.Shoes");//鞋类
